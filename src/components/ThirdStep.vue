...
import SliderTotalPath from './partials/SliderTotalPath.vue';
import SliderModifyPath from './partials/SliderModifyPath.vue';
...
<template>
    <main>
        <div class="container my_flow" id="step3">
